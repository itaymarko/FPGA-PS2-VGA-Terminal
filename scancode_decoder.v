...
reg break_flag;
reg valid_in_d;       // זיכרון שישמור את המצב הקודם של valid
wire valid_pulse;     // פולס קצר של מחזור שעון אחד

// גלאי חזית עולה (Edge Detector)
...
always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
        ...
        // עדכון הזיכרון בכל מחזור שעון
        valid_in_d <= valid_in;
        char_valid <= 1'b0;
        
        // כאן הקסם: אנחנו בודקים את הפולס במקום את הסיגנל הארוך!
